...
export default function LoadingSync({
    ...
    const containerClasses = fullScreen
        ? "fixed inset-0 z-[9999] bg-[#050505] flex flex-col items-center justify-center overflow-hidden"
        : "relative w-full min-h-[400px] flex flex-col items-center justify-center bg-black/20 rounded-3xl overflow-hidden";

    return (
        <div className={containerClasses}>
            {/* Background Grid */}
            <div className="app-grid-pattern opacity-50" />
            ...
            <div className="relative flex flex-col items-center scale-90 md:scale-100">
                ...
                <h1 className="text-4xl md:text-6xl font-black text-white font-orbitron tracking-[0.3em] animate-tactical-pulse">
                    {message}
                </h1>
                ...
                <div className="mt-8 flex gap-8">
                    ...
                    <div className="flex flex-col items-center text-center">
                        <span className="text-[8px] font-black text-gray-500 uppercase tracking-widest mb-1">Datalink</span>
